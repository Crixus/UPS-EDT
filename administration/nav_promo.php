			...
			<ul>
				...
				<li>
					<a href="?idPromotion=<?php echo $_GET['idPromotion']; ?>&amp;page=ajoutTypeCours" >Ajout d'un type de cours</a>
				</li>
			</ul>
			...
			<ul>
				...
				<li>
					<a href="?idPromotion=<?php echo $_GET['idPromotion']; ?>&amp;page=ajoutCours" >Gestion des groupes de cours </a>
				</li>
			</ul>
